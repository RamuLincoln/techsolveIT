...
| **Team Status**                           | Matrix of ticket status (Closed, In Progress, Open, Pending Customer, Resolved) by team and individual agent, plus Avg First Response & Avg Resolution Hour by category, broken out per team |
